    ...
    <section className="c-space section-spacing" id="about">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
        ...
        <div className="flex items-end grid-default-color grid-1">
          ...
          />
          <div className="z-10">
            <p className="headtext">Hi, I'm Adel Hany</p>
            <p className="subtext">
              Over the last 1 year, I developed my frontend and backend dev
              skills to deliver dynamic and software and web applications.
            </p>
            <a
              href="https://drive.google.com/uc?export=download&id=12pMjfz5uHsuIkVjZ2dQSENiVgXRboktz"
              target="_self"
              rel="noreferrer"
            >
              <button className="hover-animation mt-4 p-2 rounded-lg border-4 border-white/50 bg-blue-300/20">
                Download CV
              </button>
            </a>
          </div>
        ...
        <div className="grid-default-color grid-2">
          ...
          >
            ...
            <Card
              ...
              image="assets/logo/postgreSQl.png"
              containerRef={grid2Container}
            />
            <Card
